...
exports.WithPortal = exports.ComplexAncestry = exports.CenteredOnScreen = exports.UseAnchoredPosition = exports.default = void 0;
...
var _default = {
  ...
  Story => {
    return /*#__PURE__*/_react.default.createElement(_.ThemeProvider, null, /*#__PURE__*/_react.default.createElement(_.BaseStyles, null, Story()));
  }],
  argTypes: {
    anchorX: {
      control: {
...
const Float = (0, _styledComponents.default)(_.Position).withConfig({
  displayName: "useAnchoredPositionstories__Float",
  componentId: "sc-18cdzou-0"
})(["position:absolute;border:1px solid ", ";border-radius:", ";background-color:", ";display:flex;flex-direction:column;text-align:center;font-size:", ";font-weight:", ";padding:", ";"], (0, _constants.get)('colors.black'), (0, _constants.get)('radii.2'), (0, _constants.get)('colors.orange.3'), (0, _constants.get)('fontSizes.3'), (0, _constants.get)('fontWeights.bold'), (0, _constants.get)('space.3'));
const Anchor = (0, _styledComponents.default)(_.Position).withConfig({
  displayName: "useAnchoredPositionstories__Anchor",
  componentId: "sc-18cdzou-1"
})(["position:absolute;border:1px solid ", ";border-radius:", ";background-color:", ";display:flex;flex-direction:column;text-align:center;font-size:", ";font-weight:", ";padding:", ";"], (0, _constants.get)('colors.black'), (0, _constants.get)('radii.2'), (0, _constants.get)('colors.blue.3'), (0, _constants.get)('fontSizes.3'), (0, _constants.get)('fontWeights.bold'), (0, _constants.get)('space.3')); // eslint-disable-next-line @typescript-eslint/no-explicit-any

const UseAnchoredPosition = args => {
  var _args$anchorPosition, _args$anchorSide, _args$anchorAlignment, _args$allowOutOfBound, _args$anchorY, _args$anchorX, _position$top, _position$left, _args$floatWidth, _args$floatHeight;
  ...
  return /*#__PURE__*/_react.default.createElement(_.Relative, {
    m: 2
  ...
  }, "Anchor Element"), /*#__PURE__*/_react.default.createElement(Float, {
...
const CenteredOnScreen = () => {
  ...
  return /*#__PURE__*/_react.default.createElement(_.Position, {
    ...
    left: 0,
    right: 0
  }, /*#__PURE__*/_react.default.createElement(Float, {
    ref: floatingElementRef,
  ...
  }, /*#__PURE__*/_react.default.createElement("p", null, "Screen-Centered Floating Element "), /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement("small", null, /*#__PURE__*/_react.default.createElement("em", null, "(Controls are ignored for this story)")))));
};

exports.CenteredOnScreen = CenteredOnScreen;
CenteredOnScreen.displayName = "CenteredOnScreen";

const ComplexAncestry = () => {
  var _position$top3, _position$left3;

  const [recalculateSignal, setRecalculateSignal] = _react.default.useState(0);
  ...
  const onRecalculateClick = _react.default.useCallback(() => {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_.Box, {
  ...
  }, "Clipping container - this element has ", /*#__PURE__*/_react.default.createElement("code", null, "overflow"), " set to something other than ", /*#__PURE__*/_react.default.createElement("code", null, "visible"), /*#__PURE__*/_react.default.createElement(_.Box, {
    m: space,
    p: space,
    sx: {
      border: '1px solid #000',
  ...
  }, "Relatively positioned parent, but fluid height, so not the clipping parent.", /*#__PURE__*/_react.default.createElement(_.Box, {
    m: space,
    p: space,
    sx: {
      border: '1px solid #000',
  ...
  }, "Floating element container. Position=static and overflow=hidden to show that overflow-hidden on a statically-positioned element will not have any effect.", /*#__PURE__*/_react.default.createElement(Float, {
    ...
    height: 220,
    ref: floatingElementRef
  }, "Floating element"))), /*#__PURE__*/_react.default.createElement(_.Box, {
    m: space,
    p: space,
    backgroundColor: "blue.3",
    sx: {
  ...
  }, "Anchor element container. This element is really tall to demonstrate behavior within a scrollable clipping container.", /*#__PURE__*/_react.default.createElement(_.Box, {
    width: "200px",
    ...
    m: space,
    p: space
  }, "Anchor Element"))), /*#__PURE__*/_react.default.createElement(_Button.default, {
    onClick: onRecalculateClick
  }, "Click to recalculate floating position"));
};

exports.ComplexAncestry = ComplexAncestry;
const Nav = (0, _styledComponents.default)('nav').withConfig({
  displayName: "useAnchoredPositionstories__Nav",
  componentId: "sc-18cdzou-2"
})(["width:300px;padding:", ";position:relative;overflow:hidden;border-right:1px solid ", ";"], (0, _constants.get)('space.3'), (0, _constants.get)('colors.border.gray'));
const Main = (0, _styledComponents.default)('main').withConfig({
...
const WithPortal = () => {
  ...
  const mainRef = _react.default.useRef(null); // Calculate the position of the menu
  ...
  _react.default.useEffect(() => {
    if (mainRef.current) {
      (0, _Portal.registerPortalRoot)(mainRef.current);
    }
  }, [mainRef]); // Toggles rendering the menu when the button is clicked


  const toggleMenu = _react.default.useCallback(() => {
    setShowMenu(!showMenu);
  }, [showMenu]);

  return /*#__PURE__*/_react.default.createElement(Main, {
    ref: mainRef
  }, /*#__PURE__*/_react.default.createElement(Nav, null, /*#__PURE__*/_react.default.createElement("h2", null, "The nav bar!"), /*#__PURE__*/_react.default.createElement("p", null, "This \u201Cnav bar\u201D has a width of 300px and is ", /*#__PURE__*/_react.default.createElement("code", null, "position:relative"), " with", ' ', /*#__PURE__*/_react.default.createElement("code", null, "overflow:hidden"), ", meaning that its children cannot overflow this container. Using <Portal> with ", /*#__PURE__*/_react.default.createElement("code", null, "useAnchoredPosition"), ", we can break out of this contraint."), /*#__PURE__*/_react.default.createElement(_.Box, {
    sx: {
      textAlign: 'right'
    }
  }, /*#__PURE__*/_react.default.createElement(_.ButtonPrimary, {
    onClick: toggleMenu,
    ref: anchorElementRef
  }, "Show the overlay!"), showMenu ? /*#__PURE__*/_react.default.createElement(_Portal.default, null, /*#__PURE__*/_react.default.createElement(Float, {
    ref: floatingElementRef,
  ...
  }, "An un-constrained overlay!")) : null)), /*#__PURE__*/_react.default.createElement(_.Box, {
    sx: {
      flexGrow: 1
    },
    p: 3
  }, /*#__PURE__*/_react.default.createElement("h1", null, "The body!"), /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement("em", null, "Note: The controls below have no effect in this story."))));
};
